...
// shadcn/ui Sheet (Radix Dialog with edge slides), Sacred Curator tone.
// Replaces the legacy Sheet — used for side panels (e.g. assign role).
...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn(
        "fixed inset-0 z-50 bg-[#0c1120]/45 backdrop-blur-sm",
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "fixed z-50 flex flex-col gap-6 bg-card p-6 text-card-foreground shadow-[0_24px_60px_-12px_rgba(28,28,24,0.28)] transition ease-in-out",
      ...
      >
        {children}
        <SheetPrimitive.Close className="absolute right-4 top-4 flex h-8 w-8 items-center justify-center rounded-full text-outline transition-colors hover:bg-surface-low hover:text-on-surface focus:outline-none">
